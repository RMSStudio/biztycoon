  ...
  "runMap": {
    ...
    "bonuses": [
      { "id": "deposit_base",  "icon": "🐖", "name": "Депозитная база",
        "desc": "Разовая выплата +250 000 ₽ от размещения депозитов",
        "effects": [{ "money": 250000 }],
        "log":  "🐖 Депозитная база: +250 000 ₽" },
      { "id": "trust",         "icon": "⭐", "name": "Доверие клиентов",
        "desc": "+5 репутации — банк рекомендуют",
        "effects": [{ "rep": 5 }],
        "log":  "⭐ Доверие: +5 реп." },
      { "id": "margin",        "icon": "📈", "name": "Маржинальные продукты",
        "desc": "+5% к выплатам по всем сделкам",
      ...
      { "id": "automation",    "icon": "🤖", "name": "Автоматизация бэк-офиса",
        ...
        "log":  "🤖 Автоматизация: overhead −10%" },
      { "id": "scoring",       "icon": "🧠", "name": "Скоринг-модель",
        "desc": "+5 к качеству от кейсов навсегда (точность одобрений)",
      ...
      { "id": "legal_team",    "icon": "💳", "name": "Усиленный юр-блок",
        "desc": "+15% к шансу предоплаты от корпоратов",
        "effects": [{ "gAdd": { "perkPrepayBonus": 0.15 } }],
        "log":  "💳 Юр-блок: предоплата +15%" },
      ...
      { "id": "gov_contract",     "icon": "💼", "name": "Госконтракт по обслуживанию",
        "desc": "Разовая выплата +250 000 ₽ · +2 репутации (банк выиграл тендер бюджетников)",
        "stages": ["bank_license"],
        "effects": [{ "money": 250000 }, { "rep": 2 }],
        "log":  "💼 Госконтракт: +250 000 ₽ · +2 реп." },
      ...
      { "id": "core_banking",     "icon": "💾", "name": "Ядро АБС нового поколения",
        "desc": "Разовая выплата +400 000 ₽ от запуска новых сервисов",
        "stages": ["bank_retail"],
        "effects": [{ "money": 400000 }],
        "log":  "💾 Новое АБС: +400 000 ₽" },
      ...
      { "id": "fx_desk",          "icon": "💱", "name": "Валютный деск",
        "desc": "+7% к выплатам — комиссии с FX-операций",
        "stages": ["bank_corp"],
        "effects": [{ "gAdd": { "perkPayoutMult": 0.07 } }],
        "log":  "💱 FX-деск: выплаты +7%" },
      { "id": "syndicate_lending","icon": "🏗", "name": "Синдицированные кредиты",
        "desc": "+1 лид при скаутинге крупных сделок · +5 Q от экспертизы",
        "stages": ["bank_corp"],
        "effects": [{ "gAdd": { "caseScoutBonus": 1, "caseQBonus": 5 } }],
        "log":  "🏗 Синдикаты: +1 лид · +5 Q" },

      // 💎 Private banking
      { "id": "vip_office",       "icon": "🥂", "name": "VIP-офис в центре",
        "desc": "+10% к выплатам со всех сделок (private-маржа)",
        "stages": ["bank_private"],
        "effects": [{ "gAdd": { "perkPayoutMult": 0.10 } }],
        "log":  "🥂 VIP-офис: выплаты +10%" },
      ...
      { "id": "spo_capital",      "icon": "🏛", "name": "SPO: вышли на биржу",
        "desc": "Разовая выплата +800 000 ₽ от размещения акций",
        "stages": ["bank_topten"],
        "effects": [{ "money": 800000 }],
        "log":  "🏛 SPO: +800 000 ₽" },
      { "id": "systemic_status",  "icon": "🌐", "name": "Системно значимый",
        "desc": "Просрочка бьёт по реп −50% (статус ЦБ) · +5 репутации",
        "stages": ["bank_topten"],
        "effects": [{ "gSet": { "perkPenaltyShield": true } }, { "rep": 5 }],
        "log":  "🌐 СЗКО-статус: penalty shield · +5 реп." },
      { "id": "mna_acquisition",  "icon": "🏭", "name": "M&A: поглощение регионального банка",
        "desc": "Разовая выплата +500 000 ₽ · +15 баллов портфолио (расширили базу)",
        "stages": ["bank_topten"],
        "effects": [{ "money": 500000 }, { "gAdd": { "portfolio": 15 } }],
        "log":  "🏭 M&A: +500 000 ₽ · +15 портф." }
    ]
  },
