...
const SCENARIO = {
  ...
  settings: {
    ...
    startReputation:         60,   // стартовая репутация: T2 открыт сразу, T3 (rep≥70) и T4 (rep≥80) нарабатываются
    overhead:            35_000,   // ₽/мес постоянных расходов (аренда, ПО, связь)
  ...
  // ══════════════════════════════════════════════════
  // Бюджеты пересчитаны с учётом реальных затрат на команду:
  // T1 (Founder + Md) = ~83к/мес × 5 мес = 415к затрат → бюджет 500–950к
