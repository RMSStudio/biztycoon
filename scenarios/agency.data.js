...
window.SCENARIO_DATA = {
  ...
  "projects": [
    {
      ...
      "tier": 2,
      "icon": "🏟",
      "name": "Спонсорский пакет лиги",
      "desc": "Крупный спонсор спортлиги хочет активацию на трибунах и в эфире — жёсткие сроки под матчи.",
      "revenue": 40000,
      "minQ": 8,
      "minV": 5,
      "type": "corp",
      ...
      "oneTime": false,
      "rarity": "uncommon",
      "modifier": { "type": "nps_start", "val": 4, "label": "оценка клиента — старт +4" },
      "modBadge": "mb-green",
      "prob": 0.5
    },
    {
      ...
      "tier": 1,
      "icon": "🎪",
      "name": "Промо городского фестиваля",
      "desc": "Оргкомитет фестиваля заказывает промо-кампанию и SMM под событие.",
      "revenue": 14000,
      "minQ": 0,
      "minV": 0,
      "type": "small",
      ...
      "oneTime": false,
      "rarity": "common",
      "modifier": { "type": "nps_passive", "val": 2, "label": "+2 оценки клиента/мес" },
      "modBadge": "mb-green",
      "prob": 0.6
    },
    {
      ...
      "tier": 1,
      "icon": "🛒",
      "name": "Black Friday лендинг",
      "desc": "Магазину нужен промо-лендинг к распродаже «ещё вчера».",
      "revenue": 16000,
      "minQ": 0,
      "minV": 0,
      "type": "small",
      ...
      "oneTime": false,
      "rarity": "common",
      "modifier": { "type": "random_bonus", "val": 20000, "label": "30% шанс бонуса 20К" },
      "modBadge": "mb-teal",
      "prob": 0.65
    },
    {
      ...
      "tier": 2,
      "icon": "📦",
      "name": "Разгон карточек на маркетплейсе",
      "desc": "Селлер хочет вывести карточки в топ к пиковым продажам — performance и контент.",
      "revenue": 50000,
      "minQ": 7,
      "minV": 12,
      "type": "small",
      ...
      "oneTime": false,
      "rarity": "uncommon",
      "modifier": { "type": "revenue_growth", "val": 4000, "label": "+4К выручки/мес (рост продаж)" },
      "modBadge": "mb-teal",
      "prob": 0.5
    },
    {
      ...
      "tier": 2,
      "icon": "📑",
      "name": "Годовой отчёт корпорации",
      "desc": "Корпорации нужен дизайн и вёрстка годового отчёта для совета директоров.",
      "revenue": 38000,
      "minQ": 10,
      "minV": 0,
      "type": "corp",
      ...
      "oneTime": false,
      "rarity": "uncommon",
      "modifier": { "type": "nps_passive", "val": 3, "label": "+3 оценки клиента/мес" },
      "modBadge": "mb-green",
      "prob": 0.5
    },
    {
      ...
      "tier": 2,
      "icon": "📈",
      "name": "BI-дашборд для совета",
      "desc": "Аналитика и визуализация метрик — «покажите цифры красиво».",
      "revenue": 44000,
      "minQ": 9,
      "minV": 8,
      "type": "small",
    ...
    },
    {
      ...
      "tier": 1,
      "icon": "🎤",
      "name": "Питч-дек для раунда",
      "desc": "Основатель стартапа горит идеей и хочет питч-дек к встрече с фондом.",
      "revenue": 13000,
      "minQ": 0,
      "minV": 0,
      "type": "small",
      ...
      "oneTime": false,
      "rarity": "common",
      "modifier": { "type": "random_bonus", "val": 15000, "label": "30% шанс бонуса 15К" },
      "modBadge": "mb-teal",
      "prob": 0.65
    },
    {
      ...
      "tier": 2,
      "icon": "🧪",
      "name": "Запуск MVP стартапа",
      "desc": "Нужно быстро собрать и запустить MVP — сыро, рискованно, но быстрые деньги.",
      "revenue": 22000,
      "minQ": 0,
      "minV": 10,
      "type": "small",
      ...
      "oneTime": false,
      "rarity": "common",
      "modifier": { "type": "random_bonus", "val": 22000, "label": "30% шанс бонуса 22К" },
      "modBadge": "mb-teal",
      "prob": 0.6
    },
    {
      ...
      "tier": 2,
      "icon": "🎨",
      "name": "Полный ребрендинг",
      "desc": "Компания хочет «освежить айдентику» — логотип, гайдлайн, носители.",
      "revenue": 42000,
      "minQ": 12,
      "minV": 0,
      "type": "corp",
      ...
      "oneTime": false,
      "rarity": "uncommon",
      "modifier": { "type": "nps_start", "val": 5, "label": "оценка клиента — старт +5" },
      "modBadge": "mb-green",
      "prob": 0.5
    },
    {
      ...
      "tier": 1,
      "icon": "🖌",
      "name": "Айдентика и гайдлайн",
      "desc": "Небольшой бренд заказывает лого и мини-гайдлайн.",
      "revenue": 15000,
      "minQ": 5,
      "minV": 0,
      "type": "small",
  ...
  "upgrades": [
    ...
    },
    {
      ...
      "icon": "🤝",
      "name": "Переговорщик",
      "desc": "Разблокирует Переговорный аудит перед подписанием любого контракта: выбить аванс агрессивнее, добавить допуслугу или подписать стандартно.",
      "cost": 45000,
      "days": 2,
      "qBonus": 0,
      "repBonus": 0,
  ...
  "events": [
    ...
    },
    {
      "id": "client_happy",
      "icon": "💬",
      "title": "Клиент отметил темп работы",
      "requiresClients": true,
      "body": "Ключевой клиент написал, что команда удивила скоростью и вовлечённостью. Момент стоит использовать.",
      "choices": [
        {
          "text": "Поддержать — ответить лично",
          "desc": "Лояльность клиента +12, репутация +1",
          "effects": [
            { "nudgeRandom": 12 },
            { "rep": 1 },
        ...
        {
          "text": "Поблагодарить формально",
          "desc": "Момент упущен, изменений нет",
          "effects": [
            { "notify": ["Стандартный ответ отправлен", "info"] }
          ]
        }
      ]
    },
    {
      ...
      "requiresClients": true,
      "body": "Клиент заметил ошибки в последней итерации. Ситуация управляема, но реакция нужна быстрая.",
      "choices": [
        {
          "text": "Срочное ревью (−20 000 ₽)",
          "desc": "Закрываем проблему — лояльность +5",
          "effects": [
            { "money": -20000 },
            { "nudgeRandom": 5 },
            { "notify": ["Ревью проведено — клиент принял ✅", "success"] },
            { "rd": ["Ревью качества −20К", "event"] }
          ]
        },
        {
          "text": "Объяснить, что это норма",
          "desc": "Клиент не убеждён — лояльность −12",
          "effects": [
            { "nudgeRandom": -12 },
            { "notify": ["Клиент скептически принял объяснение 📉", "warning"] }
          ]
        }
      ]
    },
    {
      "id": "talent_raid",
      "icon": "🕵️",
      "title": "Хантинг ключевого специалиста",
      "minMonths": 24,
      "body": "Конкурирующее агентство переманивает вашего сильнейшего сотрудника. Ставки высоки.",
      "choices": [
        {
          "text": "Контроффер +40 000 ₽/мес",
          "desc": "Остаётся, но зарплата резко выше",
          "effects": [
            { "staff": { "sel": "strongest", "op": "raise", "val": 40000 } },
            { "rd": ["Удержал топа +40К/мес", "hire"] },
            { "notify": ["Специалист остался — дорого, но стабильно", "success"] }
          ]
        },
        {
          "text": "Отпустить",
          "desc": "Теряешь сильнейшего — лояльность клиентов −10",
          "effects": [
            { "staff": { "sel": "strongest", "op": "remove" } },
            { "nudgeAll": -10 },
            { "rd": ["Сильнейший ушёл к конкурентам", "churn"] },
            { "notify": ["Потеря ключевого сотрудника заметна клиентам 📉", "warning"] }
          ]
        }
      ]
    },
    {
      "id": "market_crisis",
      "icon": "📉",
      "title": "Рыночный кризис",
      "minMonths": 24,
      "requiresClients": true,
      "body": "Экономика охлаждается. Клиенты урезают бюджеты — один уже намекнул на пересмотр условий.",
      "choices": [
        {
          "text": "Антикризисный пакет (−50 000 ₽)",
          "desc": "Удерживаем отношения — лояльность всех +8",
          "effects": [
            { "money": -50000 },
            { "nudgeAll": 8 },
            { "notify": ["Антикризисный пакет сработал ✅", "success"] },
            { "rd": ["Антикризисный пакет −50К", "event"] }
          ]
        },
        {
          "text": "Переждать — рынок восстановится",
          "desc": "Лояльность всех −15, репутация −3",
          "effects": [
            { "nudgeAll": -15 },
            { "rep": -3 },
            { "notify": ["Клиенты недовольны пассивностью 📉", "error"] }
          ]
        }
      ]
    }
  ...
  "runMap": {
    "_note": "Ф.9: лестница stages удалена — прогрессию ведут стадии компании (livingmarket). Здесь остаётся только пул бонусов для чекпоинта «Прокачки» на повышении стадии.",
    "bonuses": [
      ...
      // ────────────────────────────────────────────────────────────────
      // 🏚 Гараж-студия
      { "id": "word_of_mouth",    "icon": "🔥", "name": "Сарафанное радио",
        "desc": "+1 лид при скаутинге · +2 репутации (первые довольные клиенты рекомендуют)",
        "stages": ["studio_garage"],
        "effects": [{ "gAdd": { "caseScoutBonus": 1 } }, { "rep": 2 }],
        "log":  "🔥 Сарафан: +1 лид · +2 реп." },
      { "id": "startup_grant",    "icon": "💰", "name": "Грант от акселератора",
        "desc": "Разовая выплата +180 000 ₽ — помощь от стартап-акселератора",
        "stages": ["studio_garage"],
        "effects": [{ "money": 180000 }],
        "log":  "💰 Грант: +180 000 ₽" },

      // 🛠 Команда сложилась
      { "id": "team_spirit",      "icon": "🤝", "name": "Командный дух",
        "desc": "−10 усталости · +5% к восстановлению (команда сплочённая)",
        "stages": ["studio_team"],
        "effects": [{ "fatigue": -10 }, { "gAdd": { "perkRecoveryBonus": 0.05 } }],
        "log":  "🤝 Командный дух: усталость −10, восст. +5%" },
      { "id": "process_standards","icon": "📋", "name": "Стандарты процесса",
        "desc": "+5% к скорости команды · +3 Q от кейсов (всё структурировано)",
        "stages": ["studio_team"],
        "effects": [{ "gAdd": { "speedUpgrades": 0.05, "caseQBonus": 3 } }],
        "log":  "📋 Стандарты: скорость +5% · +3 Q" },

      // 📈 Заметное агентство
      { "id": "media_feature",    "icon": "📺", "name": "Кейс в отраслевых медиа",
        "desc": "+8 баллов портфолио · +3 репутации (кейс залетел в Cossa/AdIndex)",
        "stages": ["studio_growth"],
        "effects": [{ "gAdd": { "portfolio": 8 } }, { "rep": 3 }],
        "log":  "📺 Медиа-кейс: +8 портф. · +3 реп." },
      { "id": "strategic_partner","icon": "🎯", "name": "Стратегический партнёр",
        "desc": "+1 лид · +5% к шансу предоплаты (постоянный заказчик-партнёр)",
        "stages": ["studio_growth"],
        "effects": [{ "gAdd": { "caseScoutBonus": 1, "perkPrepayBonus": 0.05 } }],
        "log":  "🎯 Стратегический партнёр: +1 лид · предоплата +5%" },
  ...
  "storyArcs": [
    ...
    {
      "id": "pivot_offer",
      "name": "Алексей возвращается с офером на пивот",
      "trigger": { "minMonth": 10, "maxMonth": 28, "requires": "old_friend", "chance": 0.5 },
      "stageDelayMonths": 3,
      "cooldown": 6,
      "stages": [
        {
          ...
          "icon": "📞",
          "title": "Звонок от Алексея",
          "body": "«Слушай, у „Берёзки“ запускается своя платформа лояльности — нужна команда поддержки на фикс. Стабильно 250К/мес, год минимум. Но это не агентская работа — это, по сути, IT-аутсорс. Решай.»",
          "choices": [
            {
              "text": "Согласиться — стабильность важнее",
              "desc": "+250К/мес три месяца, но фокус сместится",
              "effects": [
                { "log": ["📞 Пивот: «Берёзка» подписана на поддержку", "purple"] }
              ],
              "next": "commit_aftermath"
            },
            {
              "text": "Отказаться — мы агентство, не аутсорс",
              "desc": "Без денег, но не размываем экспертизу",
              "effects": [
                { "rep": 2 },
                { "log": ["📞 Алексею сказано «нет» — экспертиза дороже стабильности", "teal"] }
              ],
              "next": "decline_aftermath"
            }
          ]
        },
        {
          "id": "commit_aftermath",
          "icon": "💼",
          "title": "Три месяца на поддержке",
          "body": "Деньги капают, но команда устала: рутина вместо проектов. Сеньоры просятся обратно «на крутые задачи».",
          "choices": [
            {
              "text": "Закрыть контракт раньше срока",
              "desc": "Вернуть фокус, потерять часть денег",
              "effects": [
                { "money": 350000 },
                { "fatigue": -8 },
                { "rep": -2 },
                { "log": ["💼 Контракт «Берёзки» закрыт досрочно — возвращаемся к проектам", "amber"] }
              ],
              "end": true
            },
            {
              "text": "Доработать год — стабильность того стоит",
              "desc": "Деньги вперёд, но усталость накапливается",
              "effects": [
                { "money": 750000 },
                { "fatigue": 18 },
                { "log": ["💼 Год аутсорса: касса +750К, команда выжата", "green"] }
              ],
              "end": true
            }
          ]
        ...
        {
          "id": "decline_aftermath",
          "icon": "📰",
          "title": "Что было дальше",
          "body": "Через три месяца — новость: «Берёзка» отдала поддержку конкуренту, и они с тех пор глубоко погрязли в багах. На рынке шепчутся, что мы правильно отказались.",
          "choices": [
            {
              "text": "Использовать историю как кейс",
              "desc": "+5 реп, +5 портфолио (правильное «нет» — тоже кейс)",
              "effects": [
                { "rep": 5 },
                { "gAdd": { "portfolio": 5 } },
                { "log": ["📰 «Мы отказались — и были правы» — рассказали на конференции", "teal"] }
              ],
              "end": true
            }
          ]
    ...
    {
      "id": "tender_invite",
      "name": "Приглашение в тендер от бренда",
      "trigger": { "minMonth": 6, "maxMonth": 24, "minPortfolio": 5, "chance": 0.45 },
      "stageDelayMonths": 2,
      "cooldown": 6,
      "stages": [
        {
          "id": "letter",
          "icon": "📨",
          "title": "Письмо от тендерного отдела",
          "body": "«Дорогое агентство, приглашаем вас в закрытый тендер на годовой контракт обслуживания бренда X. Бюджет — 12М/год, конкуренты — три топовых сетевика. Подавайтесь до конца месяца.»",
          "choices": [
            {
              "text": "Подать соло",
              "desc": "Полный приз, но шансы на топ-3 невысокие",
              "effects": [
                { "log": ["📨 Тендер: подали соло-заявку", "purple"] }
              ],
              "next": "solo_resolve"
            },
            {
              "text": "Подать консорциумом с дружественным конкурентом",
              "desc": "Шанс выше, но приз делится 50/50",
              "effects": [
                { "rep": 2 },
                { "log": ["📨 Тендер: договорились с «Прогрессом» о консорциуме", "teal"] }
              ],
              "next": "consortium_resolve"
            },
            {
              "text": "Отказаться — не наш масштаб",
              "desc": "Без затрат на подготовку, но без шанса",
              "effects": [
                { "log": ["📨 Тендер: пропустили — слишком крупно", "amber"] }
              ],
              "end": true
            }
          ]
        },
        {
          "id": "solo_resolve",
          "icon": "🏆",
          "title": "Результаты тендера",
          "body": "Презентовали соло. Жюри впечатлила экспертиза, но «масштаб команды смутил». Что вышло?",
          "choices": [
            {
              "text": "Ждать вердикта",
              "desc": "Шанс победы зависит от менеджера",
              "effects": [
                {
                  "roll": {
                    "chance": 0.30,
                    "roleBonus": { "role": "manager", "add": 0.20 },
                    "success": [
                      { "money": 1800000 },
                      { "rep": 8 },
                      { "gAdd": { "portfolio": 12 } },
                      { "log": ["🏆 Тендер выигран соло! +1.8М аванс, +8 реп.", "green"] },
                      { "notify": ["🏆 Тендер бренда X — наш!", "success"] }
                    ],
                    "fail": [
                      { "money": -120000 },
                      { "rep": -1 },
                      { "log": ["🏆 Не выиграли — потратили 120К на подготовку", "red"] }
                    ]
                  }
                }
              ],
        ...
        {
          "id": "consortium_resolve",
          "icon": "🤝",
          "title": "Консорциум сработал",
          "body": "С «Прогрессом» презентовали вместе, бренд X выбрал именно вас за «двойную экспертизу». Делим приз — но и репутации хватит на двоих.",
          "choices": [
            {
              "text": "Принять условия",
              "desc": "Половина приза, но без рисков",
              "effects": [
                { "money": 900000 },
                { "rep": 5 },
                { "gAdd": { "portfolio": 8 } },
                { "log": ["🤝 Консорциум выиграл: +900К, +5 реп., +8 портф.", "green"] }
              ],
              "end": true
            }
          ]
